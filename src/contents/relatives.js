...
Page("Relatives", {
	...
	entity: {
		...
		"HasImmediateRelatives": {
			...
			"event-target": {
				...
				"N": "ctl00$SiteContentPlaceHolder$FormView1$rblUS_IMMED_RELATIVE_IND$1"
			},
			"subs": {
				"Y": {
					"ImmediateRelatives": {
	...
	hash: {
		...
		"HasImmediateRelatives": "ctl00$SiteContentPlaceHolder$FormView1$rblUS_IMMED_RELATIVE_IND",
		...
		"HasOtherRelatives": "ctl00$SiteContentPlaceHolder$FormView1$rblUS_OTHER_RELATIVE_IND"
	}
});