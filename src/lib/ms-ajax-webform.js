require("./ms-client-validation");
require("./ms-page-util");
require("./ms-post-callback");
...
Sys.WebForms.PageRequestManager = function Sys$WebForms$PageRequestManager() {
    ...
    function Sys$WebForms$PageRequestManager$_doPostBack(eventTarget, eventArgument,callback) {
    ...
    function Sys$WebForms$PageRequestManager$_onFormSubmit(evt,callback) {
        ...
        request.add_completed(Function.createDelegate(this, function(sender, eventArgs){
    ...
    function Sys$WebForms$PageRequestManager$_onFormSubmitCompleted(sender, eventArgs,callback) {
    ...
    function Sys$WebForms$PageRequestManager$_parseDelta(executor,callback) {
