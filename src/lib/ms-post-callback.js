...
window.WebForm_CallbackComplete=function() {
...
window.WebForm_FillFirstAvailableSlot=function(array, element) {
    var i;
...
window.__callbackTextTypes = /^(text|password|hidden|search|tel|url|email|number|range|color|datetime|date|month|week|time|datetime-local)$/i;
...
window.WebForm_EncodeCallback=function(parameter) {
...
window.WebForm_ReEnableControls=function() {
...
window.WebForm_ReDisableControls=function() {
    for (var i = 0; i < __disabledControlArray.length; i++) {
        __disabledControlArray[i].disabled = true;
    }
}
window.WebForm_SimulateClick=function(element, event) {
    var clickEvent;
    if (element) {
        if (element.click) {
            element.click();
...
window.WebForm_GetScrollX=function() {
    if (__nonMSDOMBrowser) {
...
window.WebForm_GetScrollY=function() {
    if (__nonMSDOMBrowser) {
...
window.WebForm_RestoreScrollPosition=function() {
    if (__nonMSDOMBrowser) {
...
window.WebForm_TextBoxKeyHandler=function(event) {
    if (event.keyCode == 13) {
        var target;
        if (__nonMSDOMBrowser) {
            target = event.target;
...
window.WebForm_TrimString=function(value) {
...
window.WebForm_GetElementById=function(elementId) {
...
window.WebForm_GetParentByTagName=function(element, tagName) {
